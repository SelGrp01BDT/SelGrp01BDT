...
public abstract class AbstractPage {
	...
	public static void unpublishItem(WebDriver driver, String itemName,String unpublishIconXpath)
	{
		
		WebElement publishIcon = driver.findElement(By.xpath(unpublishIconXpath));
		publishIcon.click();
